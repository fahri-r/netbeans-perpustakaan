 ...
 * @author Unknown
 */
public class pegawaiFormEdit extends javax.swing.JFrame {

    /**
     * Creates new form pegawaiForm
     */
    public pegawaiFormEdit() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tambahPegawai.setText("Update Data");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pegawaiFormEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pegawaiFormEdit().setVisible(true);
            }
        });
    }
